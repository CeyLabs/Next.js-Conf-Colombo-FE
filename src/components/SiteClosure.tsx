    ...
    return (
        <div className="bg-black text-neutral-200">
            <main className="relative flex min-h-screen flex-col overflow-hidden bg-black text-white">
                ...
                <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-1 flex-col px-6 py-10 lg:px-8 lg:py-16">
                    <div className="flex flex-1 flex-col items-center justify-center text-center">
                        ...
                        <p
                            ...
                            className="font-geist mt-6 max-w-xl text-sm text-neutral-300 sm:text-base"
                        >
                        ...
                        <div className="mt-10 space-y-4">
                            <div className="rounded-lg border border-white/10 bg-gradient-to-r from-black/20 to-black/10 p-4 backdrop-blur-sm">
                            ...
                            <div className="rounded-lg border border-white/10 bg-gradient-to-r from-black/20 to-black/10 p-4 backdrop-blur-sm">
                                <div className="flex items-center justify-between gap-4">
                                    <div className="flex items-center gap-3">
                                        <Image
                                            src="/assets/ceyloncash.svg"
                                            alt="Ceylon Cash Community"
                                            width={40}
                                            height={40}
                                            className="rounded-full ring-1 ring-white/10"
                                        />
                                        <div>
                                            <h3 className="font-geist text-sm font-semibold text-white">
                                                Join Ceylon Cash Community
                                            </h3>
                                            <p className="font-geist text-xs text-neutral-400">
                                                Official Ceylon Cash community
                                            </p>
                                        </div>
                                    </div>
                                    <Button
