...
type PixelBlastProps = {
    ...
    noiseAmount?: number;
    /**
     * When true, listen to pointer events on the window instead of the canvas element.
     * Useful when the effect is used as a background behind interactive content.
     */
...
const PixelBlast: React.FC<PixelBlastProps> = ({
    ...
    useEffect(() => {
        ...
        if (mustReinit) {
            ...
            const target: EventTarget = globalEvents ? window : renderer.domElement;
